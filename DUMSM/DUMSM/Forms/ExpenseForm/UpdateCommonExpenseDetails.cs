...
{
    public partial class UpdateCommonExpenseDetails : Form
    {
        GeneralExpense oldExpense;
        public UpdateCommonExpenseDetails(GeneralExpense expense)
        {
            InitializeComponent();
            oldExpense = expense;
        }

        private void UpdateCommonExpenseDetails_Load(object sender, EventArgs e)
        {
