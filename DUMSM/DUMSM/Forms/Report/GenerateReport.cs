    ...
    public partial class GenerateReport : Form
    {
        ...
        public List<string> GeneralIncomeFields()
        {
            ...
            string[] list = {"অনুদান", "স্থায়ী দাতার অনুদান", "ফরম / ভর্তি ফি", "শিক্ষার্থীর বেতন", "বোডিং/খানার চার্জ",
                    "নির্মাণ ও মেরামত","লাইব্রেরী","মাছজিদ", "ব্যাংক উত্তোলন","অনুষ্ঠান / ইফতার","বিবিধ" };
        ...
        {
            List<string> fields = new List<string>();
            string[] list = {"বেতন","মাছজিদ","ঋণ পরিশোধ","ব্যাংক জমা", "যাতায়াত", "ছাপা ও স্টেশনারী",
                    "পানি, বিদ্যুৎ ও গ্যাস", "ফোন","বোর্ডিং", "নির্মাণ ও মেরামত", "লাইব্রেরী",
                    "আসবাব পত্র","অনুষ্ঠান / ইফতার","আপ্যায়ন","সম্মানী/অডিট/বোর্ড ফি","বিবিধ"};
